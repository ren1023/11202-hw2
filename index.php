...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= 最新樓盤 Latest Properties Section ======= -->
    ...
    </section><!-- 最新樓盤 End Latest Properties Section -->

    <!-- =======超級業務員 Agents Section ======= -->
    ...
    </section><!-- 超級業務員 End Agents Section -->
    ...
    </section><!-- 最新消息 End Latest News Section -->

    <!-- ======= 感言 Testimonials Section ======= -->
    ...
    </section><!-- 感言 End Testimonials Section -->
